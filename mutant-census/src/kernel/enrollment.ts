...
export const ENROLLMENT: readonly EnrollmentRow[] = [
  ...
  { key: "b76#7", category: "process", tier: "BOOKED-UNENFORCEABLE", anchor: "", reason: "the fake-number family attempted — prose values written before the run, self-caught and replaced by the run's numbers; no machine diffs prose against the later render at value level (the b12#7/b21#3 witness-before-prose line, whose reconciliation gate is priced). Booked: the attempt face" },

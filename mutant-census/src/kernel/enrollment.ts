...
export const ENROLLMENT: readonly EnrollmentRow[] = [
  ...
  { key: "b85#33", category: "citation-drift", tier: "GATE-ENFORCED", anchor: "mutant-census/package-lock.json :: 0.30.0", reason: "" },
  { key: "b85#34", category: "citation-drift", tier: "GATE-ENFORCED", anchor: "burial-record/package-lock.json :: 0.5.0", reason: "" },
  { key: "b85#35", category: "process", tier: "BOOKED-UNENFORCEABLE", anchor: "", reason: "derivation face (the wiring agent's own, the b84#21 class recurring one batch later): the G-board resolution rows were drafted from the intended category filings before the machine's family classifier saw the new texts — four incidental phrase collisions filed rows under named families the author did not intend, and the census suite convicted the drifted runner-family resolution at its first run (the aftermath gate-held, W-H firing on every run); no scheduled gate derives the row FOR the author. Booked: the derivation face" },

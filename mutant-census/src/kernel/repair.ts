...
export const REPAIR_AUDIT: readonly RepairRow[] = [
  ...
  { key: "b78#13", verdict: "HELD", basis: "doc face: a doc comment claiming oldest-first against the code's newest-first register — no scheduled gate parses comment intent against the machine's own register-order note; the v0.2.0 docs carry the corrected statement, the comment's semantics were never wrong" },

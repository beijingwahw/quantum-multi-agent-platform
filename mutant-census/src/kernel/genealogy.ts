...
export const FAMILY_RESOLUTIONS: readonly FamilyResolution[] = [
  ...
  { family: "edit-anchor", holds: "BOOKED-UNENFORCEABLE", note: "the Edit-anchor family, six sightings since b22 — the sixth (b82#20's census package.json edit refused off a Bash cat view: a shell view is not a Read, one batch-row after b82#6's delivery-agent twin in the same batch) left nothing behind; grep the disk before anchoring, Read before Edit; no gate diffs intent" },

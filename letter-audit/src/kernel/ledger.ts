...
export const LETTER: readonly AuditRow[] = [
  ...
  },
  {
    ...
    poetry: "顺手留一点东西 / 时间胶囊",
    precise: "the capsule's contents are the platform's numbers (equivalent-80 subspace, NP-hard coupling family 5/5 vs the strongest classical Hungarian 4/5 — the R12 erratum's unified ledger, full 25-instance track quantum 25/25 vs SA 23/25; volatile counts live on the platform's own badge audit) and the burial record stands at its machine-audited declared totals (its own B7 books-agree law) — every number reproducible, ownership audited",
  ...
  },
  {
    ...
    precise: "the frontier's registry RE-AUDITED at v0.2.0 because it had fallen behind the workspace: 17 verdict rows — MECHANISM-SETTLED 8 / HEURISTIC 4 / CONDITIONAL-WALL 2 / HW-WAIT 2 / OPEN 0 / INFO-WALL 1 (v0.1.0 held 6/4/2/2/OPEN 2/1); the two OPEN rows graduated against shipped certificates — #10 the clock wall settled at the model layer (dtc-clock, the decay-law arc assembled: kappa = -0.306852819, re-based by dtc-clock v0.20.0 with Phi1 bracketed within ±5.58e-7 containing zero), #15 choice/stability settled at BOTH layers (stable-world v0.5.0 physics + choice-lang v0.2.0 language); every row now carries live-checked pointers (file + needle) into the sibling that settles or holds it",
  ...
  },
  {
    ...
    boundary: "the gate binds these repos' builds, not the world; the burial registry's full history — every batch enrolled, none retired — says the rules were needed (its declared totals are read from the registry itself, never re-quoted here)",
    exactness: "CITED",
    witness: "W-D",

...
```bash
npm ci
npm test        # 50/50 — instances, kernel machinery, power engine, tables, smuggling trials, discriminator, entry guard, the named error surface, hand-checkable gate anchors, same-seed determinism

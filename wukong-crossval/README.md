...
```bash
npm ci
npm test        # 45/45 — instances, kernel machinery, power engine, tables, smuggling trials, discriminator, entry guard, the named error surface, hand-checkable gate anchors, same-seed determinism

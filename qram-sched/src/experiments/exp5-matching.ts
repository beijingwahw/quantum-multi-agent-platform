...
export function main(): void {
  ...
  lines.push("");
  lines.push(
    "Deterministic greedy with lowest-index ties sits exactly at 1/2 on the cascade (machine-verified); uniform " +
  ...
  lines.push("");
  lines.push(
    "Observed floors stay well above the cited 1 - 1/e ~ 0.632 worst-case cap (as expected — the tight case needs " +
  ...
  lines.push("");
  lines.push(
    `Read-ratio grows with n (log2 ratio vs log2 n slope = ${fmt(fitSlope(logN, logRatio), 3)}, theory 0.5 up to the ` +
  ...
  lines.push("");
  lines.push(
    "- The 1 - 1/e tightness of RANKING and the 1/2 tightness of greedy are cited theorems (KVV 1990; Birnbaum-" +

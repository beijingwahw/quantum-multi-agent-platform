 ...
 */
export type QramErrorCode = "RNG_EMPTY_PICK" | "RNG_INT_RANGE" | "RNG_BERNOULLI_RANGE" | "LINALG_SHAPE" | "LINALG_SINGULAR" | "AE_P_RANGE" | "AE_M_RANGE" | "AE_K_RANGE" | "AE_FULLSPACE_PARAMS" | "AE_REGISTER_RANGE" | "AE_MC_PARAMS" | "QRAM_ARG_RANGE" | "QRAM_ENUM_LIMIT" | "QRAM_CELLS_SHAPE" | "QRAM_ADDRESS_RANGE" | "QRAM_CELL_RANGE" | "QRAM_P_RANGE" | "STREAM_DRAWS" | "GROVER_EMPTY_SCORES" | "GROVER_N_RANGE" | "OBM_INSTANCE_SHAPE" | "OBM_RANK_SHAPE" | "MATCH_ARG_RANGE" | "MATCH_EVEN_N" | "BANDIT_NO_ARMS" | "BANDIT_MEANS_RANGE" | "BANDIT_ARG_RANGE" | "WALK_ISOLATED_VERTEX" | "WALK_NEIGHBOR_RANGE" | "WALK_NO_TRANSIENT" | "WALK_ASYMMETRIC_SUPPORT" | "WALK_CHAIN_SHAPE" | "WALK_TARGET_RANGE" | "WALK_MU_SHAPE" | "REPRO_INCOMPLETE";
/** The only error type thrown by this repository's kernels. */
export declare class QramError extends Error {
...
export declare function reject(code: QramErrorCode, message: string): never;

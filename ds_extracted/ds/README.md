...
| 🚀 | [快速开始](#-快速开始) | 十条命令 + 代码示例 |
| 🧪 | [测试与质量](#-测试与质量) | 961 用例 · 六门禁 · 覆盖率棘轮 |
| 📁 | [目录结构](#-目录结构) | 含图集生成器 |
| 🗓️ | [版本演进](#️-版本演进时间线) | v1.0 → v1.14 |
...
**961 用例 · 0 失败 · 86 个测试文件 / 289 个套件**（性能灵敏度用例按测量环境守卫自跳过，跳过数随机器负载浮动）；六道门禁全绿，覆盖率棘轮只升不降：

...
**749 tests · 0 failures · 71 files / 231 suites**; six gates green; coverage ratchet 92/82/92/92 with measured 94.2% statements / 86.2% branches; knip dead-code sweep clean; single runtime dependency (`ws`).

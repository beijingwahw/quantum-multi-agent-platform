...
npm test                 # 1033 tests · 0 failures
...
**1033 tests · 0 failures · 91 files / 309 suites**; six gates green; coverage ratchet 92/82/92/92 with measured 94.2% statements / 86.2% branches; knip dead-code sweep clean; single runtime dependency (`ws`).

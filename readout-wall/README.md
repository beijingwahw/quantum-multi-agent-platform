...
```bash
npm ci
npm test        # 54/54 — checker, six witnesses, collapse machinery, theorem certificates, covering-partition certificates + subdivision smuggling trials, entry guard, refusal codes, single-source interchange + linalg exact anchors, same-seed determinism

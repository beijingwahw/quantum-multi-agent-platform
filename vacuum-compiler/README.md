...
0 < 5 < 9 < 43.02 kT·ln2 units, TC17 the winner) and route-price (v0.3.0)
...
64/64 tests (v0.1.0 shipped 20, v0.2.0 shipped 32, v0.3.0 shipped 41); full rebuild of all four

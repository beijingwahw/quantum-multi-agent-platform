...
function run(): void {
  ...
  const genuineCitations = [
    ...
    { repo: "route-price", version: "0.3.0", witness: "W-E", figureHundredths: 4302, depth: 11, direction: "fk-most-expensive" as const },
  ];
  ...
  const body = [
    ...
    "quoted from THIS repo's T4 static mode. route-price W-E (v0.3.0) re-priced the",
